...
class TestDataUtils(unittest.TestCase):
    ...
    def test_initialization(self):
        ...
        dataset = DocumentTapeDataset(prefix="/storage/coda1/p-schava6/0/shared/finpile/datamixes/0fp-100dolma", token_dtype=np.uint16, chunk_size=4096, eod_token_id=0)
